...
export class PastAppointmentComponent
  ...
  selection = new SelectionModel<visite>(true, []);
  index?: number;
  id?: number;
  appointment?: visite;
  constructor(
  ...
  removeSelectedRows() {
    ...
    this.selection.selected.forEach((item) => {
      ...
      this.refreshTable();
      this.selection = new SelectionModel<visite>(true, []);
    });
...
export class ExampleDataSource extends DataSource<visite> {
